...
class ServicesAktifitas {
  static Future<DataWs?> insert_aktifitas(
    ...
    FormData formData = FormData.fromMap({
      ...
      "tid": tid.toString(),
      "area": area.toString(),
      "jenis_kerusakan": jenis_kerusakan.toString(),
      "solusi_perbaikan": solusi_perbaikan.toString(),
      "pergantian_tid": pergantian_tid.toString(),
      "pergantian_simcard": pergantian_simcard.toString(),
      "pergantian_psam": pergantian_psam.toString(),
